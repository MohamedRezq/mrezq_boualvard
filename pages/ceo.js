  ...
  return (
    <>
      ...
      >
        ...
        <div className="w-full flex flex-col md:flex-row md:space-x-36">
          <div className="w-full hidden md:block md:w-5/12 relative">
            <Image src={ceoImg} layout="fill" />
          </div>
          ...
          <div className="w-full md:w-7/12">
            <div className="flex flex-col justify-between space-y-16">
              <div className="text-golden text-4xl mt-10 md:mt-0">
                {ceoMsgTitle}
              </div>
              <div className="flex flex-col justify-between space-y-5">
                <div className="text-stonish text-sm">{ceoMsgPassage11}</div>
                <div className="text-stonish text-sm">{ceoMsgPassage12}</div>
              </div>
            </div>
          </div>
        </div>
        <div className="text-stonish text-sm flex flex-col space-y-5 py-5">
